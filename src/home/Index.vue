<template>
    <div class="cnt">
        <Header></Header>
        <div>
            <a href="/test/epic/321" target="_blank">页面跳转到test</a>
            <a href="/test/detail/123" target="_blank">新开页面跳转到detail</a>
            <button @click="onClickJump">当前页跳转</button>
            <button @click="onClickOpen">新开页面跳转</button>
            <a href="/test/list/321">当前页跳转list</a>
            <p>成为遗憾的小心愿</p>
            <a href="/test/list/321" class="news">
                <img src="/images/banner17.jpg" width="100px" height="100px" alt="空">
            </a>
        </div>
        <!-- vue-improve-loader -->
        <div check-reduce>
